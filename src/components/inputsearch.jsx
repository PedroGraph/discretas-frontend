    ...
    return(
        ...
        <div className="relative max-w-[600px] w-full lg:p-4 xs:p-0">
          <div className="flex">
            ...
            <button
              className="xs:block lg:hidden ml-auto rounded-l-none rounded-r-full xs:bg-black lg:bg-[#8941ff] hover:bg-[#8941ff] xs:p-0 lg:px-4 lg:py-2 text-white"
              onClick={""}
            >
              <SearchIcon className="xs:h-6 xs:w-7 lg:h-4 lg:w-4" />
            </button>
        ...
        {/* {isFullScreen && (
          <div className="fixed inset-0 bg-white z-50 p-4 flex flex-col items-center">
            <div className="w-full max-w-2xl mt-8 relative">
              <div className="flex">
              <button
                  className="xs:block lg:hidden rounded-l-none rounded-r-full bg-[#8941ff] hover:bg-[#8941ff] px-4 py-2 text-white"
                ...
                <input
                  ...
                  autoFocus
                />
              <button className='bg-[#8941ff] hover:bg-[#8941ff] px-4 py-2 text-xs text-white ml-auto' onClick={searchProducts}>Buscar producto</button>
              </div>
