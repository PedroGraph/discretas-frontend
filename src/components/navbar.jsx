...
export default function Navbar() {
  return (
    <nav className="bg-black flex py-1 gap-4 justify-between">
      <a className="w-1/6 px-4 flex items-center" href="/">
        <img
          className="xs:h-[15px] lg:h-[54px]"
          src={logo}
          alt="Logo"
          loading="lazy"
        />
      ...
      <ul className="w-1/2 items-center justify-end gap-4 px-2 xs:hidden lg:flex">
      ...
      <div className="flex items-center px-2 xs:hidden lg_block">
        <button className="w-16 h-8 rounded bg-white dark:!bg-slate-600 relative transition-colors duration-500 ease-in focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600 focus:border-transparent">
          <div
            className={`absolute left-1 top-1 w-6 h-6 rounded-full transition-transform duration-500 ease-in-out flex items-center justify-center dark:!translate-x-8 `}
          >
            <svg
      ...
      <div className=" items-center px-2 xs:hidden lg:flex">
      ...
      <Link to="/login" className=" items-center px-2 xs:hidden lg:flex">
      ...
      <details className="xs:block lg:hidden">
        <summary className="list-none">
          <HamburguerIcon className={"h-10 w-10 px-2 xs:block lg:hidden"} />
        </summary>
        <div className="absolute right-0 bg-black top-[45px] z-20  w-full flex flex-col items-end animation-ctn">
          <a href="/tienda" className="text-white text-xs py-2 px-2">
            Todos los productos
          </a>
          <a href="/lubricante" className="text-white text-xs py-2 px-2">
            Lubricantes
          </a>
          <a href="/lenceria" className="text-white text-xs py-2 px-2">
            Lenceria
          </a>
          <a href="/ordenes" className="text-white text-xs py-2 px-2">
            Mis ordenes
          </a>
          <a href="/login" className="text-white text-xs p-2">
            Cerrar sesión
          </a>
