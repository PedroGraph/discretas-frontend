...
const showComments = async (universityId) => {
    return await axios.post(`http://https://discretas-backend.onrender.com/json-com/comentarios`,{
...
async function updatedLike(comentarioId, info, action) {
  await axios.post(`http://https://discretas-backend.onrender.com/json-com/comentarios/updatelikes`,{
...
async function deleteComment(comentarioId) {
  await axios.post(`http://https://discretas-backend.onrender.com/json-com/comentarios/deletecomment`,{
