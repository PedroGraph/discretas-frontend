...
const showComments = async (universityId) => {
    return await axios.post(`http://127.0.0.1:3000/json-com/comentarios`,{
...
async function updatedLike(comentarioId, info, action) {
  await axios.post(`http://127.0.0.1:3000/json-com/comentarios/updatelikes`,{
...
async function deleteComment(comentarioId) {
  await axios.post(`http://127.0.0.1:3000/json-com/comentarios/deletecomment`,{
